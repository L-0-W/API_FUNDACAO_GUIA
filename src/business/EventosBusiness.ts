      ...
      if (filtros.status) {
        ...
        switch (filtros.status) {
          ...
          case filtragemEventosStatus.Encerrado:
            break;
          case filtragemEventosStatus.Programado:
            break;
          ...
          case filtragemEventosStatus.Vazio:
            ...
            responseBuilder.adicionarMensagem(
              "Filtro de status precisa esta entre futuros | em_andamento | encerrado | cancelado | concluido",
            );
            throw new Error(catchErros.CLIENTE);
            break;
          default:
